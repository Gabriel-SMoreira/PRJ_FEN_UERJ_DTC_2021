model controletrif
  ...
  Modelica.Mechanics.Rotational.Components.Inertia inertia(J = 0.001170, a(start = 0), phi(displayUnit = "rad", start = 0), w(start = 0)) annotation(
    Placement(visible = true, transformation(origin = {123, 21}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
  ...
  Modelica.Mechanics.Rotational.Components.Fixed fixed annotation(
    Placement(visible = true, transformation(origin = {164, -6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.RealExpression Tq_Ref(y = 100)  annotation(
    Placement(visible = true, transformation(origin = {202, -65}, extent = {{12, -15}, {-12, 15}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.RealExpression Banda_3H(y = 5)  annotation(
    Placement(visible = true, transformation(origin = {216, -121}, extent = {{12, -13}, {-12, 13}}, rotation = 0)));
...
equation
  ...
  connect(inertia.flange_b, quadraticSpeedDependentTorque.flange) annotation(
    Line(points = {{134, 21}, {154, 21}, {154, 22}}));
  ...
  connect(Banda_3H.y, histerese_3.Bd) annotation(
    Line(points = {{203, -121}, {190, -121}, {190, -158}, {150, -158}}, color = {0, 0, 127}));
  connect(Tq_Ref.y, histerese_3.Tr) annotation(
    Line(points = {{189, -65}, {176, -65}, {176, -140}, {150, -140}}, color = {0, 0, 127}));
